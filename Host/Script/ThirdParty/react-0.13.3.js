    ...
    var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++) s(r[o]); return s })({
        1: [function (_dereq_, module, exports) {
            ...
            var DOMProperty = {
                 ...
                 *
                 * TO-DO: Is it better to grab all the possible properties when creating an
            ...
            var ReactChildReconciler = {
                ...
                updateChildren: function (
                  ...
                  context) {
                    ...
                    // moved.
                    // TO-DO: If nothing has changed, return the prevChildren object so that we
             ...
             * leaf child.
             *
             * TO-DO: This may likely break any calls to `ReactChildren.map` that were
            ...
            var ReactClassMixin = {
                ...
                /**
                 * TO-DO: This will be deprecated because state should always keep a consistent
             ...
             * the browser context. TO-DO: These callers should be refactored to avoid the
            ...
            var ReactCompositeComponentMixin = {
                ...
                unmountComponent: function () {
                    ...
                    // TO-DO: inst.props = null;
                    // TO-DO: inst.state = null;
                    // TO-DO: inst.context = null;
                },
                ...
                _checkPropTypes: function (propTypes, props, location) {
                    // TO-DO: Stop validating prop types here and only use the element
                    // validation.
                 ...
                 * TO-DO: Remove this check when owner-context is removed
                 */
                ...
                _renderValidatedComponent: function (childContext) {
                    ...
                    ("production" !== "development" ? invariant(
                      // TO-DO: An `isValidNode` function would probably be more appropriate
                      renderedComponent === null || renderedComponent === false ||
                      ReactElement.isValidElement(renderedComponent),
                      '%s.render(): A valid ReactComponent must be returned. You may have ' +
                        'returned undefined, an array or some other invalid object.',
                      this.getName() || 'ReactCompositeComponent'
                    ) : invariant(// TO-DO: An `isValidNode` function would probably be more appropriate
                    renderedComponent === null || renderedComponent === false ||
                    ReactElement.isValidElement(renderedComponent)));
                    return renderedComponent;
                },
            ...
            ReactDOMComponent.Mixin = {
                 ...
                 *
                 * TO-DO: Benchmark whether checking for changed values in memory actually
                 *       improves performance (especially statically positioned elements).
                 * TO-DO: Benchmark the effects of putting this at the top since 99% of props
                 *       do not change for a given reconciliation.
                 * TO-DO: Benchmark areas that can be improved with caching.
                 *
                 * @private
            ...
            var ReactDOMForm = ReactClass.createClass({
                ...
                render: function () {
                    // TO-DO: Instead of using `ReactDOM` directly, we should use JSX. However,
            ...
            var ReactDOMOption = ReactClass.createClass({
                ...
                componentWillMount: function () {
                    // TO-DO (yungsters): Remove support for `selected` in <option>.
                    if ("production" !== "development") {
                        ("production" !== "development" ? warning(
             ...
             *
             * TO-DO: Investigate representing React components in the DOM with text nodes.
             *
            ...
            assign(ReactDOMTextComponent.prototype, {
                ...
                construct: function (text) {
                    // TO-DO: This is really a ReactText (ReactNode), not a ReactElement
                ...
                receiveComponent: function (nextText, transaction) {
                    if (nextText !== this._currentElement) {
                        ...
                        if (nextStringText !== this._stringText) {
                            // TO-DO: Save this as pending props and use performUpdateIfNecessary
            ...
            var ReactDOMTextarea = ReactClass.createClass({
                ...
                getInitialState: function () {
                    var defaultValue = this.props.defaultValue;
                    // TO-DO (yungsters): Remove support for children content in <textarea>.
            ...
            var ReactDefaultPerf = {
                ...
                printExclusive: function (measurements) {
                    ...
                    // TO-DO: ReactDefaultPerfAnalysis.getTotalTime() does not return the correct
                    // number.
                },
                ...
                _recordWrite: function (id, fnName, totalTime, args) {
                    // TO-DO: totalTime isn't that useful since it doesn't count paints/reflows
                    var writes =
                      ReactDefaultPerf
            ...
            function getTotalTime(measurements) {
                // TO-DO: return number of DOM ops? could be misleading.
                // TO-DO: measure dropped frames after reconcile?
                // TO-DO: log total time of each reconcile and the top-level component
            ...
            var ReactElement = function (type, key, ref, owner, context, props) {
                ...
                // TO-DO: Deprecate withContext, and then the context becomes accessible
                // through the owner.
                this._context = context;
            ...
            ReactElement.createFactory = function (type) {
                ...
                // Legacy hook TO-DO: Warn if this is accessed
                factory.type = type;
                return factory;
            };
            ...
            ReactElement.isValidElement = function (object) {
                ...
                // TO-DO: We could possibly warn here.
                // }
                return isElement;
            };
            ...
            function validatePropTypes(element) {
                ...
                // TO-DO: Validating a string's propTypes is not decoupled from the
            ...
            ReactEmptyComponentType.prototype.componentDidMount = function () {
                var internalInstance = ReactInstanceMap.get(this);
                // TO-DO: Make sure we run these methods in the correct order, we shouldn't
            ...
            ReactEmptyComponentType.prototype.componentWillUnmount = function () {
                var internalInstance = ReactInstanceMap.get(this);
                // TO-DO: Get rid of this check. See TO-DO in componentDidMount.
                if (!internalInstance) {
                    return;
                }
            ...
            function findParent(node) {
                // TO-DO: It may be a good idea to cache this to prevent unnecessary DOM
            ...
            */
            ...
            // TO-DO: Replace this with ES6: var ReactInstanceMap = new Map();
                ...
                Mixin: {
                    ...
                    updateTextContent: function (nextContent) {
                        ...
                        try {
                            ...
                            // TO-DO: The setTextContent operation should be enough
            ...
            var Mixin = {
                 ...
                 *   TO-DO: convert to array<TransactionWrapper>
                 */
                getTransactionWrappers: function () {
                    return TRANSACTION_WRAPPERS;
                },
            ...
            ReactRef.shouldUpdateRefs = function (prevElement, nextElement) {
                ...
                // TO-DO: Should this even be possible? The owner cannot change because
            ...
            var ReactUpdateQueue = {
                ...
                enqueueCallback: function (publicInstance, callback) {
                    ...
                    // TO-DO: The callback here is ignored when setState is called from
            ...
            if (ExecutionEnvironment.canUseDOM) {
                ...
                if (testElement.innerHTML === '') {
                    setInnerHTML = function (node, html) {
                        ...
                        // TO-DO: What to do on a detached node?
                        if (node.parentNode) {
